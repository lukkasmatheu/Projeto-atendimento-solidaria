...
function MenuGrid(props){
    return(
        <div id="menu-items" className={props.name}>
                <ItemGrid link="/chat" text= "CHAT" span={props.span} spanClass = {props.spanCl} imgMenu={chat} description= "chat anonimo " active="" to={props.to}/>
